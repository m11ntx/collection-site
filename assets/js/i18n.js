...
(function (root, factory) {
    ...
    const STRINGS = {
        pt: {
            ...
            common: { labelCollection: "Coleção", labelLeague: "Liga", labelRegion: "Região", labelClub: "Clube", labelJersey: "Camisa" },
            collectionDetail: {
            ...
            journey: {
                ...
                steps: [
                    ...
                    { label: "Contato pelo Instagram" },
                    { label: "Confirmação da disponibilidade" },
                    { label: "Importação" },
                    { label: "Prazo estimado", sub: "25–40 dias corridos" },
                    { label: "Entrega" }
                ],
                importInfoEyebrow: "Informações de Importação",
                importInfoText: "A M11NTX atua como intermediadora na aquisição de camisas " +
                    "importadas. A disponibilidade será confirmada antes do atendimento.",
                deliveryLabel: "Prazo estimado", deliveryValue: "25–40 dias corridos",
                faqEyebrow: "FAQ", faqTitle: "Perguntas Frequentes",
                faq: [
                    { q: "Como funciona a compra?", a: "A M11NTX atua como intermediadora na aquisição de camisas importadas. Você escolhe a peça, consulta a disponibilidade pelo nosso Instagram e conduzimos todo o processo de importação até a entrega." },
                    { q: "Qual é o prazo de entrega?", a: "O prazo estimado é de 25–40 dias corridos, contados após a confirmação da disponibilidade e do atendimento. Por se tratar de importação, pequenas variações podem ocorrer." },
                    { q: "Como funciona a disponibilidade?", a: "A disponibilidade de cada camisa é confirmada individualmente antes do pedido. Ao consultar, verificamos a peça, o tamanho e a versão desejada." },
                    { q: "Como falo com a M11NTX?", a: "Todo o atendimento é feito pelo nosso Instagram oficial. Toque em “Consultar Disponibilidade” em qualquer camisa, ou fale conosco pela página de Atendimento." },
                    { q: "As camisas são importadas?", a: "Sim. Trabalhamos com camisas importadas, adquiridas sob consulta para cada cliente." },
                    { q: "Como é feito o pagamento?", a: "O pagamento é combinado durante o atendimento personalizado, fora da plataforma. Nada é cobrado automaticamente pelo site." },
                    { q: "Vocês têm loja física?", a: "Não. A M11NTX é uma plataforma digital; todo o atendimento acontece pelo Instagram oficial." }
                ]
            },
            page404: {
            ...
            institutional: {
                about: {
                    ...
                    body: "<p>A M11NTX é um projeto premium de cultura do futebol dedicado às camisas que carregam história — camisas retrô e clássicas selecionadas, apresentadas com a reverência que merecem.</p>" +
                        "<p>Não somos uma loja tradicional. A M11NTX atua como <strong>intermediadora</strong> na aquisição de camisas importadas: você escolhe a peça, confirmamos a disponibilidade e conduzimos toda a importação até ela chegar às suas mãos.</p>" +
                ...
                howItWorks: {
                    ...
                    body: "<p>A M11NTX atua como intermediadora: a disponibilidade é sempre confirmada antes do pedido e a compra é feita por atendimento personalizado. Saiba mais na <a href=\"pages/intermediation-policy.html\">Política de Intermediação</a>.</p>"
                },
                faq: {
                ...
                contact: {
                    ...
                    body: "<p>Todo o atendimento da M11NTX é feito pelo nosso Instagram oficial — de forma pessoal e direta. Escolha a camisa, consulte a disponibilidade e conduzimos todo o processo com você.</p>",
                    talkOnInstagram: "Falar no Instagram", sendEmail: "Enviar e-mail",
                    updated: "Prazo estimado de importação: 25–40 dias corridos, após a confirmação."
                },
                privacy: {
                    eyebrow: "Privacidade", h1: "Política de Privacidade",
                    body: "<p>Esta política descreve como a M11NTX trata as informações ao usar esta plataforma. Prezamos pela transparência e pela coleta mínima de dados.</p>" +
                        "<h2>Dados que tratamos</h2><ul><li>Dados de navegação e medição de audiência (ex.: Google Analytics 4 e Microsoft Clarity), de forma agregada.</li><li>Informações que você compartilha voluntariamente ao nos contatar pelo Instagram ou e-mail.</li></ul>" +
                        "<p>A plataforma não realiza vendas diretas nem processa pagamentos; portanto, não coletamos dados de pagamento pelo site.</p>" +
                        "<h2>Como usamos</h2><ul><li>Para entender o uso do site e melhorar a experiência.</li><li>Para responder e conduzir o atendimento que você iniciar.</li></ul>" +
                        ...
                        "<h2>Compartilhamento</h2><p>Compartilhamos dados apenas com os provedores de medição citados e com as plataformas de contato (Instagram/Meta), conforme suas próprias políticas.</p>" +
                ...
                terms: {
                    ...
                    body: "<p>Ao utilizar esta plataforma, você concorda com os termos abaixo.</p>" +
                        "<h2>Sobre a plataforma</h2><p>A M11NTX é uma vitrine digital e atua como <strong>intermediadora</strong> na aquisição de camisas importadas. Não realizamos vendas diretas nem processamos pagamentos pelo site.</p>" +
                        "<h2>Disponibilidade e prazos</h2><ul><li>A disponibilidade de cada camisa é <strong>confirmada antes do pedido</strong>.</li><li>O prazo estimado de importação é de <strong>25–40 dias corridos</strong>, podendo variar por se tratar de importação.</li></ul>" +
                        "<h2>Atendimento e pagamento</h2><p>A compra é realizada mediante atendimento personalizado, pelo Instagram oficial, com condições combinadas fora da plataforma.</p>" +
                ...
                intermediationPolicy: {
                    ...
                    body: "<p>A M11NTX atua como <strong>intermediadora</strong> na aquisição de camisas importadas. Não realizamos vendas diretas pela plataforma.</p>" +
                        "<ul><li>A compra é realizada mediante <strong>atendimento personalizado</strong>, pelo nosso Instagram oficial.</li><li>A <strong>disponibilidade</strong> de cada camisa será <strong>sempre confirmada antes do pedido</strong>.</li><li>O prazo estimado de importação é de <strong>25–40 dias corridos</strong>, contados após a confirmação.</li></ul>" +
                        "<h2>Como funciona</h2><p>Você escolhe a peça, consulta a disponibilidade, confirmamos as condições e conduzimos a importação até a entrega. Veja o passo a passo em <a href=\"pages/how-it-works.html\">Como Funciona</a>.</p>" +
        ...
        en: {
            ...
            common: { labelCollection: "Collection", labelLeague: "League", labelRegion: "Region", labelClub: "Club", labelJersey: "Jersey" },
            collectionDetail: {
            ...
            journey: {
                ...
                importInfoText: "M11NTX acts as an intermediary in acquiring imported jerseys. " +
                    "Availability will be confirmed before service.",
                deliveryLabel: "Estimated delivery", deliveryValue: "25–40 calendar days",
                faqEyebrow: "FAQ", faqTitle: "Frequently Asked Questions",
                faq: [
                    { q: "How does the purchase work?", a: "M11NTX acts as an intermediary in acquiring imported jerseys. You choose the piece, check availability through our Instagram, and we handle the entire import process through to delivery." },
                    { q: "What is the delivery time?", a: "The estimated timeframe is 25–40 calendar days, counted after availability is confirmed and service begins. Since these are imports, small variations may occur." },
                    { q: "How does availability work?", a: "Each jersey's availability is confirmed individually before ordering. When you inquire, we check the piece, size and desired version." },
                    { q: "How do I talk to M11NTX?", a: "All service happens through our official Instagram. Tap “Check Availability” on any jersey, or reach us through the Contact page." },
                    { q: "Are the jerseys imported?", a: "Yes. We work with imported jerseys, acquired on request for each customer." },
                    { q: "How is payment made?", a: "Payment is arranged during personalized service, outside the platform. Nothing is charged automatically by the site." },
                    { q: "Do you have a physical store?", a: "No. M11NTX is a digital platform; all service happens through our official Instagram." }
                ]
            },
            page404: {
            ...
            institutional: {
                ...
                howItWorks: {
                    ...
                    body: "<p>M11NTX acts as an intermediary: availability is always confirmed before ordering and the purchase is made through personalized service. Learn more in the <a href=\"pages/intermediation-policy.html\">Intermediation Policy</a>.</p>"
                },
                faq: {
                ...
                contact: {
                    ...
                    body: "<p>All M11NTX support happens through our official Instagram — personally and directly. Choose the jersey, check availability, and we'll guide you through the whole process.</p>",
                    talkOnInstagram: "Message us on Instagram", sendEmail: "Send an email",
                    updated: "Estimated import time: 25–40 calendar days, after confirmation."
                },
                privacy: {
                    eyebrow: "Privacy", h1: "Privacy Policy",
                    body: "<p>This policy describes how M11NTX handles information when you use this platform. We value transparency and minimal data collection.</p>" +
                        "<h2>Data we process</h2><ul><li>Browsing and audience-measurement data (e.g. Google Analytics 4 and Microsoft Clarity), in aggregate form.</li><li>Information you voluntarily share when contacting us via Instagram or email.</li></ul>" +
                        "<p>The platform does not process direct sales or payments; we therefore do not collect payment data through the site.</p>" +
                        "<h2>How we use it</h2><ul><li>To understand site usage and improve the experience.</li><li>To respond to and carry out any service you initiate.</li></ul>" +
                        ...
                        "<h2>Sharing</h2><p>We share data only with the measurement providers listed above and with the contact platforms (Instagram/Meta), per their own policies.</p>" +
                ...
                terms: {
                    ...
                    body: "<p>By using this platform, you agree to the terms below.</p>" +
                        "<h2>About the platform</h2><p>M11NTX is a digital showcase and acts as an <strong>intermediary</strong> in acquiring imported jerseys. We do not process direct sales or payments through the site.</p>" +
                        "<h2>Availability and timeframes</h2><ul><li>Each jersey's availability is <strong>confirmed before ordering</strong>.</li><li>The estimated import time is <strong>25–40 calendar days</strong>, and may vary since these are imports.</li></ul>" +
                        "<h2>Service and payment</h2><p>The purchase is made through personalized service, via our official Instagram, with terms arranged outside the platform.</p>" +
                ...
                intermediationPolicy: {
                    ...
                    lead: "Transparency about how we conduct every acquisition.",
                    body: "<p>M11NTX acts as an <strong>intermediary</strong> in acquiring imported jerseys. We do not make direct sales through the platform.</p>" +
                        "<ul><li>The purchase is made through <strong>personalized service</strong>, via our official Instagram.</li><li>Each jersey's <strong>availability</strong> will <strong>always be confirmed before ordering</strong>.</li><li>The estimated import time is <strong>25–40 calendar days</strong>, counted after confirmation.</li></ul>" +
                        "<h2>How it works</h2><p>You choose the piece, check availability, we confirm the terms, and we handle the import through to delivery. See the step-by-step in <a href=\"pages/how-it-works.html\">How It Works</a>.</p>" +
                        "<p>Our commitment is to clarity: nothing is charged automatically and every step is agreed with you before moving forward.</p>",
                    updated: "Last updated: July 2026."
                }
            }
        }
